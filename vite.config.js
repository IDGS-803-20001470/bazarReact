...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      injectRegister: "auto",
      includeAssets: ["public/android", "public/ios", "public/windows11"], // Aqui se ponen si los queremos guardar en cache
      manifest: {
        name: "BAZAR PWA RICARDO REYNA",
        short_name: "BAZAR RICREYNA PWA",
        description: "BAZAR PWA RICARDO REYNA ",
        theme_color: "#ffffff",
        icons: [
          {
